...
Questions and answers grounded in **this** codebase, organised against the fifteen
categories in [docs/intervew-aspects.md](docs/intervew-aspects.md).

> 基于**本代码库**的面试问答，按 [docs/intervew-aspects.md](docs/intervew-aspects.md) 里的十五个类别组织。
...
**Tier 1 — Language & runtime / 语言与运行时**
[1. C# & .NET internals](#1-c--net-runtime-internals) ·
[2. JavaScript fundamentals](#2-javascript-fundamentals--language-internals) ·
[3. TypeScript](#3-typescript)

**Tier 2 — Framework & platform / 框架与平台**
[4. ASP.NET Core depth](#4-aspnet-core-framework-depth) ·
...
**Tier 3 — Cross-cutting / 横切工程能力**
[9. Browser, network & performance](#9-browser-network--web-performance) ·
...
[13. Security](#13-security-full-stack) ·
[14. Testing](#14-testing-full-stack)

**Tier 4 — Practice / 职业实践**

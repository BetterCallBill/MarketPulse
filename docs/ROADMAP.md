...
Five slices remain. Sizing assumes the ~8-task shape of slices 1–3; slices marked **may
...
*Depends on:* 8 (done), so that what gets deployed is already instrumented.
